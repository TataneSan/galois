...
impl GénérateurIR {
    ...
    fn nom_fonction_native(&self, nom: &str) -> String {
        match nom {
            ...
            "existe_chemin" => "gal_systeme_existe_chemin".to_string(),
            "est_fichier" => "gal_systeme_est_fichier".to_string(),
            "est_dossier" => "gal_systeme_est_dossier".to_string(),
            "creer_dossier" => "gal_systeme_creer_dossier".to_string(),
            "supprimer_fichier" => "gal_systeme_supprimer_fichier".to_string(),
            "supprimer_dossier" => "gal_systeme_supprimer_dossier".to_string(),
            "taille_fichier" => "gal_systeme_taille_fichier".to_string(),
            ...
            "est_ipv6" => "gal_reseau_est_ipv6".to_string(),
            ...
            "sin" | "sinus" => "gal_sin".to_string(),
            "cos" | "cosinus" => "gal_cos".to_string(),
            "tan" | "tangente" => "gal_tan".to_string(),
            "arcsin" | "arcsinus" => "gal_arcsin".to_string(),
            "arccos" | "arccosinus" => "gal_arccos".to_string(),
            "arctan" | "arctangente" => "gal_arctan".to_string(),
            "arctan2" => "gal_arctan2".to_string(),
            "log" | "logarithme" => "gal_log".to_string(),
            "exp" | "exponentielle" => "gal_exp".to_string(),
